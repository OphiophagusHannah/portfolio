...
const Canvas = (props) => {
  ...
  useEffect(() => {
    ...
    class Blob {
      ...
      get radius() {
        return this._radius || canvas.width / 5;
      }
      ...
      get position() {
        return this._position || { x: 0.3, y: 0.52 };
      }

      get divisional() {
        return (Math.PI * 20) / this.numPoints;
      }

      get center() {
        return {
          x: this.canvas.width * this.position.x * 1.2,
